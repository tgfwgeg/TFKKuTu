...
var $data = {};
var $lib = { Classic: {}, Jaqwi: {}, Crossword: {}, Typing: {}, Hunmin: {}, Daneo: {}, Sock: {}, Sansung: {}, Drawing: {} };
var $rec;
var mobile;
...
$(document).ready(function(){
	...
	$data._soundList = [
		...
		{ key: "rain", value: "/media/kkutu/rain.mp3" },
	];
...
// 메뉴 버튼
	...
	$stage.dialog.settingOK.on('click', function(e){
		applyOptions({
			...
			theme: $("#theme-select").val() || 'default'
		});
